...
$query = "SELECT * FROM user_info WHERE (username = '$username' OR 
email='$email'OR pno='$pno')";
$data = mysqli_query($dbc,
$query);if
(mysqli_num_rows($data) ==
0) {
$query = "INSERT INTO user_info 
(username,password,email,pno,bloodgroup,name)VALUES ('$username',
'$pass', '$email','$pno','$bloodgroup','$name')"; mysqli_query($dbc,
$query)
